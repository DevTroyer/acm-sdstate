                    ...
                    <ul className="list-unstyled">
                        <li className="media">
                            <div className="media-body">
                                ...
                                <br/>
                                <a href="https://visualstudio.microsoft.com/downloads/" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-outline-primary">Download Visual Studio</button></a>
                            </div>
                        </li>
                        <li className="media">
                            <div className="media-body">
                                ...
                                <br/>
                                <a href="https://docs.microsoft.com/en-us/visualstudio/debugger/?view=vs-2019" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-outline-primary">Learn to Debug</button></a>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul className="list-unstyled">
                        <li className="media my-4">
                            <div className="media-body">
                                ...
                                <br/>
                                <a href="https://visualstudio.microsoft.com/downloads/" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-outline-primary">Download Visual Studio Code</button></a>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul className="list-unstyled">
                        <li className="media">
                            <div className="media-body">
                                ...
                                <br/>
                                <a href="https://gitforwindows.org/" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-outline-primary">Download Git</button></a>
                            </div>
                        </li>
                        <li className="media">
                            <div className="media-body">
                                ...
                                <br/>
                                <a href="https://tutorialzine.com/2016/06/learn-git-in-30-minutes" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-outline-primary">Learn Git</button></a>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul className="list-unstyled">
                        <li className="media my-4">
                            <div className="media-body">
                                ...
                                <br/>
                                <a href="https://github.com/join" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-outline-primary">Create GitHub Account</button></a>
                            </div>
                        </li>
                    </ul>
                </div>
